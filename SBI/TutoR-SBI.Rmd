...
Bootvtlg <- do(1000) * prop(~linda, success = "Richtig", data = resample(Linda))
```
...
In welchem Bereich liegen z.B. $95\,\%$ der Anteile der Resamples? Diese Frage beantwortet z.B. das Bootstrap-Percentil **Konfidenzintervall**:
