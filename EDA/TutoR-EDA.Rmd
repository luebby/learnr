...
`mosaic` (und `ggformula`) verwenden ein einheitliches Formelinterface (`formula`) für grafische Darstellungen, Kennzahlen, aber auch für Modellierung und Inferenz:
