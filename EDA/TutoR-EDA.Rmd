...
In diesem Tutorium geht es darum, dass Sie lernen wie Sie mit [mosaic](https://projectmosaic.github.io/mosaic/){target="_blank"} und [ggformula](https://projectmosaic.github.io/ggformula/){target="_blank"} schnell und einfach Informationen aus Daten entdecken können.
...
Dieses Tutorium orientiert sich teiweise an einem Tutorial des [StatPREP](http://statprep.org/){target="_blank"} Projektes.
