...
Wie oben schon hergeleitet verwendet `mosaic` (und `ggformula`) ein einheitliches Formel-Interface (`formula`) für grafische Darstellungen und Kennzahlen, aber auch für Modellierung und Inferenz:
