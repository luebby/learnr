...
Aufgrund der Struktur der befragten Personen (Stichprobe) kann das Ergebnis **nicht** generalisiert werden, alle Auswertungen beziehen sich daher **nur** auf die Stichprobe. Auch können vielfältige Formen der **Verzerrung** vorliegen: Lügen, Nicht-Antworten usw..
...
question("Stimmt die Aussage: das Durchschnittseinkommen von FOM Studierenden liegt bei ca. 1627.61 €?",
         answer("Ja", message = "Aufgrund der nicht-zufälligen Stichprobe ist eine Verallgemeinerung des Ergebnisses **ncht** möglich. Die Aussage stimmt nur für diese Stichprobe!"),
         answer("Nein", correct = TRUE, message = "Aufgrund der nicht-zufälligen Stichprobe ist eine Verallgemeinerung des Ergebnisses **ncht** möglich."))
```
