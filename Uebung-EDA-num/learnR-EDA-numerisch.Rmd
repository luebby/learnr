...
Damit wir die Daten dieser nutzen können, müssen wir die Daten in R einlesen. Diese liegen als csv Datei (Endung `csv`) vor. 
...
Ergänzen Sie den Code so, dass Sie den Wert für Deutschland (`Germany`) erhalten.
