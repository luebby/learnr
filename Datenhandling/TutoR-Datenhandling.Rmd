...
Wenn mehrere Bedingungen vorliegen, die kombiniert werden sollen, gibt es mehrere Möglichkeiten: 

- Wenn beide Bedingungen erfüllt sein müssen, wird ein (logisches) und (mathematisch: $\land$, in R: `&`) verwendet.

- Wenn nur eine Bedingung erfüllt sein muss, wird in oder (mathematisch: $\lor$, in R: `|`) verwendet.
