...
question("Gemäß der Abbildung: im welchen Kontinent scheint der Zusammenhang am schwächsten zu sein?",
  ...
  answer("Europe", correct = TRUE, message = "Für eine genaue Untersuchung wird dann jeweils ddie *kontinentspezifische* Steigung betrachtet."),
...
Visuell unterscheidet sich der der Zusammenhang $\beta_1$ zwischen den Kontinenten -- der Kontinent *moderiert* den Zusammenhang. Dies kann auch in der Modellierung berücksichtigt werden. Über `+` werden Variablen hinzugefügt, über `:` eine Wechselwirkung, Interaktion.
