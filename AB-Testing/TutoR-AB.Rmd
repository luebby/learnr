...
Beachte, dass ein Mittelwert von $0$ vom Konfidenzintervall überdeckt wird. In $2.5\, \%$ der Resamples beträgt die Differenz des Mittelwertes von `roa` maximal `r confint(Bootvtlg.diffmean)$lower` (ist also $\leq$), in $2.5\, \%$ der Resamples ist sie mindestens `r confint(Bootvtlg.diffmean)$upper` (ist also $\geq$). 
